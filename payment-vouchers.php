...
<head>
    ...
    <title>سندات الصرف - نظام الأباسي الموحد</title>
...
<body class="dashboard">
        ...
        <div class="container">
            <div class="navbar-content">
                ...
                <div class="navbar-menu">
                    ...
                    <a href="payment-vouchers.php" class="nav-link active">سندات الصرف</a>
        ...
        <div class="dashboard-content">
            <div class="page-header">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h1 class="page-title">📤 سندات الصرف</h1>
                        <p class="page-subtitle">إدارة سندات الصرف والمدفوعات</p>
                    </div>
            ...
            <div class="vouchers-table">
                <div class="table-header">
                    <h3 style="margin: 0;">قائمة سندات الصرف</h3>
                    <div>
    ...
    <div class="modal" id="voucherModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">سند صرف جديد</h2>
            ...
            <form id="voucherForm" onsubmit="saveVoucher(event)">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>المدفوع إلى <span class="required">*</span></label>
                        <input type="text" id="paidTo" name="paidTo" 
    ...
    <script src="js/payment-vouchers.js"></script>
</body>
</html>
