    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="card">
                ...
                <form action="{{ route('accounts.update', $account) }}" method="POST" id="accountForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">رقم الحساب (يمكن تعديله)</small>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               id="is_main_true" 
                                               value="1"
                                               {{ old('is_main', $account->is_main) == '1' ? 'checked' : '' }}
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               id="is_main_false" 
                                               value="0"
                                               {{ old('is_main', $account->is_main) == '0' ? 'checked' : '' }}
                                               onchange="toggleAnalyticalType()">
                        ...
                        <div class="row" id="parent_account_row" style="display: {{ old('is_main', $account->is_main) == '1' ? 'block' : 'none' }};">
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row" id="analytical_type_row" style="display: {{ old('is_main', $account->is_main) == '0' ? 'block' : 'none' }};">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="analytical_account_type_id" 
                                        ...
                                        @foreach($analyticalAccountTypes as $type)
                                            <option value="{{ $type->id }}" {{ old('analytical_account_type_id', $account->analytical_account_type_id) == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        @if($account->children()->count() > 0)
                            <div class="alert alert-warning">
                                ...
                                <strong>تحذير:</strong> هذا الحساب يحتوي على {{ $account->children()->count() }} حساب فرعي. 
                                تغيير بعض الإعدادات قد يؤثر على الحسابات الفرعية.
                            </div>
                        @endif
                    </div>
